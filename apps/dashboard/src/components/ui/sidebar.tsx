    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            'group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar @container/content',
            className
          )}
          {...props}
        >
...
function Sidebar({
  ...
  return (
    <div
      className='group peer hidden shrink-0 text-sidebar-foreground md:flex'
      data-state={state}
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-[var(--sidebar-width)] min-w-[var(--sidebar-width)] bg-transparent transition-[width,min-width] duration-200 ease-linear',
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] group-data-[collapsible=icon]:min-w-[var(--sidebar-width-icon)]',
          'group-data-[state=collapsed]:w-[var(--sidebar-width-icon)] group-data-[state=collapsed]:min-w-[var(--sidebar-width-icon)]'
        )}
      />
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ? 'p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)] group-data-[state=collapsed]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]'
            : 'group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)] group-data-[state=collapsed]:w-[var(--sidebar-width-icon)] group-data-[side=left]:border-e group-data-[side=right]:border-s',
          className
        )}
        {...props}
      >
...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='header'
      className={cn('flex flex-col gap-2 p-2 pb-2', className)}
      {...props}
    />
  )
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 group-data-[state=collapsed]:-mt-8 group-data-[state=collapsed]:opacity-0',
        className
      )}
      {...props}
    />
